...
if os.path.exists("lr") and os.path.exists("bayes") and os.path.exists("dt"):
    ...
    for sample_size in (0.001, 0.002, 0.005, 0.01, 0.015, 0.020, 0.025):
        ...
        print('Bayes Test Area Under ROC', evaluator_bayes.evaluate(bayes_pr))
        print('Lr Test Area Under ROC', evaluator_lr.evaluate(lr_pr))
        print('Dt Test Area Under ROC', evaluator_dt.evaluate(dt_pr))
